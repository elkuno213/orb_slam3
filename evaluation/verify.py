...
_EUROC_V1_01_GT: Final[str] = (
    "euroc-mav/V1_01_easy/mav0/state_groundtruth_estimate0/data.csv"
)
_EUROC_V1_02_GT: Final[str] = (
    "euroc-mav/V1_02_medium/mav0/state_groundtruth_estimate0/data.csv"
)
